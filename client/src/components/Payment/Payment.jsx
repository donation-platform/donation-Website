...
export default function Payment() {
    // تعيين userId و itemId بشكل ثابت لاختبار الدفع
    const userId = "1";  
    const itemId = "240ed9bf-5b64-494a-aabb-b1a2de278dad"; 
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8 rtl">
            <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:shadow-xl">
                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4">
                    <h1 className="text-white text-xl font-bold text-center">معلومات الدفع الآمنة</h1>
                </div>
                ...
                <form onSubmit={handleSubmit} className="px-6 py-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className={`border rounded-md p-3 cursor-pointer transition duration-150 ${paymentMethod === 'بطاقة ائتمانية' ? 'border-indigo-500 bg-indigo-50' : 'border-gray-300 hover:border-indigo-300'}`}
                            ...
                            <div className={`border rounded-md p-3 cursor-pointer transition duration-150 ${paymentMethod === 'باي بال' ? 'border-indigo-500 bg-indigo-50' : 'border-gray-300 hover:border-indigo-300'}`}
                    ...
                    <div className="flex items-center justify-center mt-4">
                        ...
                        <span className="text-xs text-gray-500">جميع البيانات مشفرة ومؤمنة</span>
                    </div>
                </form>
            </div>
        </div>
